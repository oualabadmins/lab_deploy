...
The **ArcSight SIEM Base Configuration - Public** provisions a test environment on a public virtual network consisting of a CentOS Linux VM with ArcSight SIEM installed, and one or more Windows 10 VMs.
