...
| :-------------------         | :-------------------                                    | :-------------------
| &#x1F34E; [**5-tier-AD-base-config**](5-tier-AD-base-config/README.md)         | 5-Tier AD Base Configuration - Public                  | **Lab admins** - This is the **Golden Template** for public lab deployments! Use this template for multi-VM farms with a custom AD domain in PUBLIC (non-corpnet connected) subscriptions. <br> The 5-Tier AD Base Configuration template provisions a flexible lab environment with a custom AD domain in a public subscription.  You can choose to deploy the following five tiers: AD DC, SQL Server, Application server, SharePoint Server, and Windows 10 client.
